...
```
We don't get a message because the previous published 
message was sent before the subscriber subscribed.
...
[The py files in github](https://github.com/GoogleCloudPlatform/training-data-analyst/tree/master/courses/streaming/publish)
