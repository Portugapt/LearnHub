...
def main():
    ...
    st.markdown('Are shrooms edible or poisonous?')
    st.sidebar.markdown('Are shrooms edible or poisonous?')
    ...
    if classifier == 'Logistic Regression':
        ...
        max_iter = st.sidebar.slider("Max number of iters", 100, 500, key="max_iter")
        ...
        if st.sidebar.button('Classify', key='classify'):
            st.subheader("Logistic Regession - Results")
    ...
    if classifier == 'Random Forest':
        ...
        bootstrap = st.sidebar.checkbox('Bootstrap samples?', ('True'), key='bootstrap')
